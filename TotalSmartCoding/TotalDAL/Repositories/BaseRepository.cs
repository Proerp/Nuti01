...
namespace TotalDAL.Repositories
{
    public class BaseRepository : IBaseRepository
    {
        ...
        private void InitReports()
        {
            ...
            this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, OptionBoxIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportID.ProductionJournal002 + ", " + (int)GlobalEnums.ReportID.ProductionJournal002 + ", 1, N'1.BÁO CÁO THEO BATCH', N'Báo cáo thành phẩm chi tiết', N'ProductionJournal002', N'" + reportTabPageIDs + "', N'" + optionBoxIDs + GlobalEnums.OBx(GlobalEnums.OptionBoxID.SummaryVersusDetail) + "', " + (int)GlobalEnums.ReportTypeID.ProductionJournal + ", 20, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
            this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, OptionBoxIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportID.ProductionJournal003 + ", " + (int)GlobalEnums.ReportID.ProductionJournal003 + ", 1, N'1.BÁO CÁO THEO BATCH', N'Báo cáo thành phẩm tổng hợp', N'ProductionJournal003', N'" + reportTabPageIDs + "', N'" + optionBoxIDs + "', " + (int)GlobalEnums.ReportTypeID.ProductionJournal + ", 30, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
            ...
            this.ExecuteStoreCommand("SET IDENTITY_INSERT Reports ON  INSERT INTO Reports (ReportID, ReportUniqueID, ReportGroupID, ReportGroupName, ReportName, ReportURL, ReportTabPageIDs, OptionBoxIDs, ReportTypeID, SerialID, Remarks) VALUES (" + (int)GlobalEnums.ReportID.ProductionJournal005 + ", " + (int)GlobalEnums.ReportID.ProductionJournal005 + ", 2, N'2.BÁO CÁO THEO NGÀY SẢN XUẤT', N'Báo cáo thành phẩm tổng hợp', N'ProductionJournal003', N'" + reportTabPageIDs + "', N'" + optionBoxIDs + "', " + (int)GlobalEnums.ReportTypeID.ProductionJournal + ", 30, N'')      SET IDENTITY_INSERT Reports OFF ", new ObjectParameter[] { });
        }
